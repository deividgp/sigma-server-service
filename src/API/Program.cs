        ...
        options.Events = new JwtBearerEvents
        {
            OnMessageReceived = context =>
            {
                ...
                if (
                    ...
                    && path.StartsWithSegments("/serverchannelhub")
                )
                {
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "ServerService API", Version = "v1" });
...
app.MapHub<ServerChannelHub>("/serverchannelhub");
